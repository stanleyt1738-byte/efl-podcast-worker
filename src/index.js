...
const TRANSFERS = [
  ...
  {div:'League One',club:'Sheffield Wednesday',player:'Ricardo Santos',age:31,from:'Swansea City',fee:'Free',type:'in',date:'19 Jun 2026',status:'confirmed',src:'https://www.swfc.co.uk/news/2026/june/19/santos-signs-for-wednesday/'},
  ...
  {div:'League One',club:'Sheffield Wednesday',player:'Callum Slattery',age:26,from:'Motherwell',fee:'Free',type:'in',date:'1 Jul 2026',status:'confirmed'},
  ...
  {div:'League One',club:'Sheffield Wednesday',player:'Sil Swinkels',age:22,from:'Aston Villa',fee:'Undisclosed',type:'in',date:'2 Jul 2026',status:'confirmed',src:'https://readastonvilla.com/2026/07/02/aston-villa-sil-swinkels-sheffield-wednesday-transfer-2/'},
  ...
  {div:'Championship',club:'Watford',player:'Giorgi Chakvetadze',age:26,to:'Udinese',fee:'Undisclosed',type:'out',date:'6 Jul 2026',status:'confirmed',src:'https://www.watfordfc.com/news/2026/july/06/official-chakvetadze-joins-udinese/'},
  ...
  {div:'League One',club:'Sheffield Wednesday',player:'Louie Barry',age:20,from:'Aston Villa',fee:'TBC',type:'in',date:'Jul 2026',status:'rumour',src:'https://www.thestar.co.uk/sport/football/sheffield-wednesday/sheffield-wednesday-news-harry-gray-transfer-8773637'},
  {div:'League One',club:'Sheffield Wednesday',player:'Harry Gray',age:17,from:'Leeds United (loan)',fee:'Loan',type:'in',date:'Jul 2026',status:'rumour',src:'https://www.thestar.co.uk/sport/football/sheffield-wednesday/sheffield-wednesday-news-harry-gray-transfer-8773637'},
  ...
  {div:'League One',club:'Oxford United',player:'Bamba Dieng',age:26,from:'Lorient (free agent) — also chased by Blackburn, Leicester, Portsmouth, St Pauli',fee:'Free',type:'in',date:'Jun 2026',status:'rumour',src:'https://footballleagueworld.co.uk/blackburn-leicester-oxford-portsmouth-set-to-tussle-for-bamba-dieng-lorient/'},
...
function transfersPage() {
  ...
  const renderRow = (t) => {
    ...
    const srcLabel = t.status === 'confirmed' ? 'Source' : 'Evidence';
    const srcLink = t.src ? `<a class="t-src" href="${t.src}" target="_blank" rel="noopener">${srcLabel} ↗</a>` : '';
    return `<div class="t-row">
      ${arrow}
      <div class="t-player"><span class="t-name">${t.player}</span><span class="t-age">Age ${t.age}</span></div>
      <div class="t-move">${move}</div>
      <div class="t-meta">${t.fee ? `<span class="t-fee">${t.fee}</span>` : ''}${statusChip(t.status)}${srcLink}</div>
...
.t-src{font-size:11px;font-weight:700;color:#0056A2;text-decoration:none;border-bottom:1px dotted #0056A2}
.t-src:hover{color:#1B3A28;border-bottom-color:#1B3A28}
